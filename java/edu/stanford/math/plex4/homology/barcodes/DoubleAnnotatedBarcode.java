 ...
 *
 */
public class DoubleAnnotatedBarcode<T> {
	 ...
	 */
	public DoubleAnnotatedBarcode(int dimension) {
	 ...
	 */
	public DoubleAnnotatedBarcode<T> getInfiniteIntervals() {
		DoubleAnnotatedBarcode<T> infiniteBarcode = new DoubleAnnotatedBarcode<T>(this.dimension);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DoubleAnnotatedBarcode<?> other = (DoubleAnnotatedBarcode<?>) obj;
