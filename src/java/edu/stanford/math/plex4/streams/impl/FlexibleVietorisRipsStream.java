...
public class FlexibleVietorisRipsStream<T> extends FlagComplexStream {
	 ...
	 * @param converter the Filtration Converter to be used
	 */
	public FlexibleVietorisRipsStream(AbstractSearchableMetricSpace<T> metricSpace, 
			double maxDistance, 
			int maxDimension, 
	...
	public FlexibleVietorisRipsStream(AbstractSearchableMetricSpace<T>
		metricSpace, double maxDistance, int maxDimension,
		FiltrationConverter converter, StreamStorageStructure<Simplex> storageStructure) {
	...
	public FlexibleVietorisRipsStream(AbstractSearchableMetricSpace<T> metricSpace, 
					  double maxDistance, 
					  int maxDimension,
					  FiltrationConverter converter, int[] indices) {
