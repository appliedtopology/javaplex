 ...
 *
 */
public class IntAugmentedBarcode<T> {
	 ...
	 */
	public IntAugmentedBarcode(int dimension) {
	 ...
	 */
	public IntAugmentedBarcode<T> getInfiniteIntervals() {
		IntAugmentedBarcode<T> infiniteBarcode = new IntAugmentedBarcode<T>(this.dimension);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IntAugmentedBarcode<?> other = (IntAugmentedBarcode<?>) obj;
