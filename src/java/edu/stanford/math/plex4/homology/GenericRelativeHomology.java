...
public class GenericRelativeHomology<F, T> extends GenericPersistentHomology<F, T> {
	...
	public GenericRelativeHomology(ObjectAbstractField<F> field, Comparator<T> comparator, int minDimension, int maxDimension) {
		super(field, comparator, minDimension, maxDimension);
	}
	
	public GenericRelativeHomology(ObjectAbstractField<F> field, Comparator<T> comparator, int maxDimension) {
