...
public class MappingUtility {
	public static <T extends PrimitiveBasisElement, U extends PrimitiveBasisElement> IntFormalSum<U> computeImage(IntFormalSum<GenericPair<T, U>> function, T element) {
	...
	public static <F, T extends PrimitiveBasisElement, U extends PrimitiveBasisElement> GenericFormalSum<F, U> computeImage(GenericFormalSum<F, GenericPair<T, U>> function, T element) {
