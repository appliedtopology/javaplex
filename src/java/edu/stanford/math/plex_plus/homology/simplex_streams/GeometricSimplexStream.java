 ...
 *
 */
public class GeometricSimplexStream implements SimplexStream<Simplex>, FiniteMetricSpace<double[]> {
	private final SimplexStream<Simplex> stream;
	private final FiniteMetricSpace<double[]> metricSpace;
	
	public GeometricSimplexStream(SimplexStream<Simplex> stream, FiniteMetricSpace<double[]> metricSpace) {
	...
	public GeometricSimplexStream(SimplexStream<Simplex> stream, double[][] points) {
		ExceptionUtility.verifyNonNull(stream);
	...
	public GeometricSimplexStream(SimplexStream<Simplex> stream, GraphEmbedding embedding, int dimension) {
		ExceptionUtility.verifyNonNull(stream);
	...
	public int getDimension() {
		return this.stream.getDimension();
	}
	...
	private AbstractUndirectedGraph construct1Skeleton(SimplexStream<Simplex> stream) {
