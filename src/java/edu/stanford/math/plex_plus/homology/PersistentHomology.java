 ...
 * @param <T>
 */
public class PersistentHomology<T extends ChainBasisElement> {
	private final IntField field;
	private final Comparator<T> comparator;

	public PersistentHomology(IntField field, Comparator<T> comparator) {
		this.field = field;
		this.comparator = comparator;
	}

	public AugmentedBarcodeCollection<T> computeIntervals(SimplexStream<T> stream, int maxDimension) {
	...
	public AugmentedBarcodeCollection<T> getIntervalsFromDecomposition(GenericPair<THashMap<T, IntFormalSum<T>>, THashMap<T, IntFormalSum<T>>> RV_pair, SimplexStream<T> stream) {
		AugmentedBarcodeCollection<T> barcodeCollection = new AugmentedBarcodeCollection<T>();
