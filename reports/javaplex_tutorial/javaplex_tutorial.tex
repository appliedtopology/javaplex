...
To install JavaPlex for Matlab, go to the latest release at \url{https://github.com/appliedtopology/javaplex/releases/latest/}. Download the zip file containing the Matlab examples, which should be called something like \texttt{matlab-examples\-4.2.1.tar.gz}. Extract the zip file. The resulting folder should be called \texttt{matlab\_examples}.
