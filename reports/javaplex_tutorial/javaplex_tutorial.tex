...
% These lines should be after "\tableofcontents" so that the spacing in the table of contents is not increased.
\setlength{\parindent}{0pt}
\setlength{\parskip}{8pt}

% standardize citations in tutorial wiki
...
The following Matlab scripts containing the commands in this tutorial are available in the folder \texttt{matlab\_examples/tutorial\_examples}. This means that you don't need to type in each command individually. % Add note? DONT coy and paste commands from pdf
\begin{itemize}
...
\begin{wrapfigure}{r}{1in}
	\begin{center}
   	\includegraphics[width=1in]{house.pdf}
  	\end{center}
\end{wrapfigure}
...
The Matlab function \texttt{plot\_barcodes.m} lets us display the intervals as Betti barcodes. The four inputs are \texttt{intervals}, the minimum dimension barcode to plot, the maximum dimension barcode to plot, and a string for the filename. 
\begin{quote} \begin{verbatim}
...
%The second dimensional Betti plot does not appear because there are no $Betti_2$ intervals.
...
% TODO: explain crazy plot_barcodes optional inputs above
The file \texttt{ripsTorus.png} is saved to your current directory. %We do not show these figures because the plots are very tall.
...
%TODO - these comments are not obvious with the new plot system plot_barcodes.m
...
\section{Exercise solutions}\label{A:solutions} %TODO: reference this label
