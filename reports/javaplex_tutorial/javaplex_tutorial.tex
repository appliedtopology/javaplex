...
{\em House example.} Let's build a Vietoris--Rips stream from the house point cloud in \S \ref{euc}. Note this stream is different than the explicit house stream we built in \S \ref{explicitStreamPers}.
...
num\_simplices = 82479 \hspace{40mm} \% Generally close to 80000\\
\\
