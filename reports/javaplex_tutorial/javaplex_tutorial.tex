...
To install JavaPlex for Matlab, go the the website \url{https://github.com/appliedtopology/javaplex/}. Download the zip file from the latest release containing the Matlab examples. It should be called something like \texttt{matlab-examples\-4.2.0.tar.gz}. Extract the zip file. The resulting folder should be called \texttt{matlab\_examples}.
