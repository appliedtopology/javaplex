...
% TODO: latest build (update downloads files)
...
To install javaPlex for Matlab, go the the website
\url{http://code.google.com/p/javaplex/downloads/list}. Download the zip
file containing the Matlab examples. It should be called something like
\texttt{matlab-examples\-4.0.0.tar.gz}. % TODO: this file is out of date
...
>> api.Plex4.createBarcodePlot(filtration_value_intervals, ...
                               'witnessTorus', max_filtration_value)
\end{verbatim}
\end{quote}
...
\begin{solution}
See the Matlab script \texttt{exercise\_3\_1\_1.m} for a solution. We use 9 vertices, which we think of as a $3 \times 3$ grid numbered as a telephone keypad. We identify opposite sides.
\end{solution}
