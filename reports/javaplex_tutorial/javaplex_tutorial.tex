...
Let's build a WitnessStream instance for $100,000$ random points from the unit torus $S^1 \times S^1$ in $\mathbb{R}^4$, with 50 random landmarks. %The order of inputs is \texttt{createWitnessStream(landmark\_selector}, $d_{max},\ t_{max},\ N$\texttt{)}.
