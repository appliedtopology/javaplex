...
\centering
\mbox{
\subfigure{\includegraphics[width=1in]{images/torus_0.png}}\quad
\subfigure{\includegraphics[width=1in]{images/torus_1.png}}\quad
\subfigure{\includegraphics[width=1in]{images/torus_2.png}}\quad
\subfigure{\includegraphics[width=1in]{images/torus_3.png}}\quad
\subfigure{\includegraphics[width=1in]{images/torus_4.png}}\quad
\subfigure{\includegraphics[width=1in]{images/torus_5.png} }}
...
\centering
\mbox{
\subfigure{\includegraphics[width=2in]{images/lazy-witness-torus-0.png}}\quad
\subfigure{\includegraphics[width=2in]{images/lazy-witness-torus-1.png}}\quad
\subfigure{\includegraphics[width=2in]{images/lazy-witness-torus-2.png} }}
