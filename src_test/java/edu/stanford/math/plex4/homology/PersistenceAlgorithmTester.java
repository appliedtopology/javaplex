...
public class PersistenceAlgorithmTester {
	 ...
	 * 
	 * @param <T> the underying basis type
	 ...
	 */
	public static <T> void verifyEqualityAll(List<AbstractPersistenceAlgorithm<T>> algorithms, Iterable<AbstractFilteredStream<T>> streams) {
