...
public class HomComplexTest {
	...
	public static <F extends Number> void simplicialHomTest(ObjectAbstractField<F> field) {
		/*
		int domainCardinality = 4;
		AbstractSearchableMetricSpace<double[]> domainMetricSpace = new EuclideanMetricSpace(getFigure8Vertices());
		AbstractSearchableMetricSpace<double[]> codomainMetricSpace = new EuclideanMetricSpace(PointCloudExamples.getEquispacedCirclePoints(domainCardinality));
		...
		*/
		...
		AbstractSearchableMetricSpace<double[]> domainMetricSpace = new EuclideanMetricSpace(PointCloudExamples.getEquispacedCirclePoints(domainCardinality));
		AbstractSearchableMetricSpace<double[]> codomainMetricSpace = new EuclideanMetricSpace(PointCloudExamples.getEquispacedCirclePoints(codomainCardinality));
		...
		*/
		...
		/*
		AbstractSearchableMetricSpace<double[]> domainMetricSpace = new EuclideanMetricSpace(PointCloudExamples.gettetrahedronVertices());
		AbstractSearchableMetricSpace<double[]> codomainMetricSpace = new EuclideanMetricSpace(PointCloudExamples.getoctahedronVertices());
		...
		*/
		...
		double r_max = 0.2;
		int d_max = 3;
		AbstractSearchableMetricSpace<double[]> domainMetricSpace = new EuclideanMetricSpace(PointCloudExamples.getRandomSpherePoints(n, 1));
		AbstractSearchableMetricSpace<double[]> codomainMetricSpace = new EuclideanMetricSpace(PointCloudExamples.getRandomSpherePoints(n, 1));
